...
pthread_mutex_t mutex1 = PTHREAD_MUTEX_INITIALIZER; //mutex for generator function
...
void * generator_function(void* junk) {
    ...
    pthread_mutex_lock(&mutex2);//lock mutex for condition signal, locked by calling thread to prevent undefined behavior.
    pthread_cond_signal(&condition);//wakes printer;
